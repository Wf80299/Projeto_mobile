...
// --- Dados de Exemplo ---
// Lista de unidades de tempo
const List<String> _unidadesTempo = ['Horas', 'Minutos'];
...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return const MaterialApp(
      title: 'Conversor de Tempo', // Título alterado
      home: TimeConverterScreen(), // Classe inicial alterada
    );
  }
}